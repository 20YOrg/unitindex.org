...
export default async function HomePage() {
  ...
  const supportBackgroundUrl = `${directusUrl}/assets/${homePageData.support_background}`; // New background for the title1 section
  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      {/* Title1 Section */}
      <div 
        className={styles.title1Section} 
        style={{ 
          backgroundImage: `url(${supportBackgroundUrl})`,
        }}
      >
        <h2>{homePageData.title1}</h2>
      </div>
    </div>
  );
}